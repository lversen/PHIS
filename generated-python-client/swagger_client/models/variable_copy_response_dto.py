...
class VariableCopyResponseDTO(object):
    ...
    def __init__(self, variable_uris=None, entity_uris=None, characteristic_uris=None, method_uris=None, unit_uris=None, interest_entity_uris=None, _configuration=None):  # noqa: E501
