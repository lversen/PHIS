...
class MetricPeriodDTO(object):
    ...
    def __init__(self, start_date=None, end_date=None, scientific_object_list=None, experiment_list=None, data_list=None, device_list=None, germplasm_list=None, _configuration=None):  # noqa: E501
