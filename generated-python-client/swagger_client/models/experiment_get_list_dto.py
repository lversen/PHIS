...
class ExperimentGetListDTO(object):
    ...
    def __init__(self, uri=None, name=None, start_date=None, end_date=None, description=None, objective=None, species=None, is_public=None, facilities=None, _configuration=None):  # noqa: E501
