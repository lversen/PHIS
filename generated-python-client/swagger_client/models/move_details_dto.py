...
class MoveDetailsDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, start=None, end=None, is_instant=None, description=None, targets=None, relations=None, _from=None, to=None, targets_positions=None, publication_date=None, last_updated_date=None, publisher=None, _configuration=None):  # noqa: E501
