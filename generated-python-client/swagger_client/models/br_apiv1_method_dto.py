...
class BrAPIv1MethodDTO(object):
    ...
    def __init__(self, description=None, formula=None, method_db_id=None, method_name=None, ontology_reference=None, reference=None, _class=None, _configuration=None):  # noqa: E501
