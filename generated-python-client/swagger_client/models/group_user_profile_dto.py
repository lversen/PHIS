...
class GroupUserProfileDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, profile_uri=None, profile_name=None, user_uri=None, user_name=None, publication_date=None, last_updated_date=None, _configuration=None):  # noqa: E501
    ...
    def user_uri(self, user_uri):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and user_uri is None:
