...
class UserUpdateDTO(object):
    ...
    def __init__(self, uri=None, first_name=None, language=None, password=None, admin=None, last_name=None, email=None, enable=None, favorites=None, linked_person=None, _configuration=None):  # noqa: E501
    ...
    def admin(self, admin):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and admin is None:
