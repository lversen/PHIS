...
class Statement(object):
    ...
    def __init__(self, boolean=None, byte=None, short=None, char=None, _int=None, long=None, _float=None, double=None, resource=None, object=None, language=None, string=None, literal=None, list=None, model=None, subject=None, bag=None, alt=None, seq=None, predicate=None, reified=None, _configuration=None):  # noqa: E501
