...
class AccountCreationDTO(object):
    ...
    def __init__(self, uri=None, email=None, admin=None, language=None, enable=None, favorites=None, password=None, linked_person=None, _configuration=None):  # noqa: E501
