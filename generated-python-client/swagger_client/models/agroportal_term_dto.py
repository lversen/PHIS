...
class AgroportalTermDTO(object):
    ...
    def __init__(self, id=None, name=None, synonym=None, definitions=None, ontology_name=None, obsolete=None, type=None, links=None, _configuration=None):  # noqa: E501
    ...
    def ontology_name(self, ontology_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and ontology_name is None:
