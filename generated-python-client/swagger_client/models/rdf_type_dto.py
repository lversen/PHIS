...
class RDFTypeDTO(object):
    ...
    def __init__(self, uri=None, name=None, comment=None, parent=None, publisher=None, publication_date=None, last_updated_date=None, _configuration=None):  # noqa: E501
