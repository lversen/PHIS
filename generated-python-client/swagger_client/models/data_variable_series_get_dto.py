...
class DataVariableSeriesGetDTO(object):
    ...
    def __init__(self, variable=None, provenances=None, devices=None, data_series=None, calculated_series=None, last_data_stored=None, _configuration=None):  # noqa: E501
