...
class VariablesGroupGetDTO(object):
    ...
    def __init__(self, uri=None, publisher=None, publication_date=None, last_updated_date=None, name=None, description=None, variables=None, _configuration=None):  # noqa: E501
