...
class BrAPIv1StudyDTO(object):
    ...
    def __init__(self, active=None, additional_info=None, common_crop_name=None, documentation_url=None, end_date=None, location_db_id=None, location_name=None, program_db_id=None, program_name=None, start_date=None, study_db_id=None, study_name=None, study_type_db_id=None, study_type_name=None, trial_db_id=None, trial_name=None, seasons=None, _configuration=None):  # noqa: E501
