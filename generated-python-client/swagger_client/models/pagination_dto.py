...
class PaginationDTO(object):
    ...
    def __init__(self, page_size=None, current_page=None, total_count=None, total_pages=None, limit_count=None, has_next_page=None, _configuration=None):  # noqa: E501
