...
class BrAPIv1GermplasmDTO(object):
    ...
    def __init__(self, accession_number=None, acquisition_date=None, biological_status_of_accession_code=None, breeding_method_db_id=None, common_crop_name=None, country_of_origin_code=None, default_display_name=None, documentation_url=None, donors=None, germplasm_db_id=None, germplasm_genus=None, germplasm_name=None, germplasm_pui=None, germplasm_species=None, institute_code=None, institute_name=None, pedigree=None, seed_source=None, species_authority=None, subtaxa=None, subtaxa_authority=None, synonyms=None, taxon_ids=None, source_name=None, taxon_id=None, type_of_germplasm_storage_code=None, _configuration=None):  # noqa: E501
