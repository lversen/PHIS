...
class VueRDFTypeDTO(object):
    ...
    def __init__(self, uri=None, name=None, comment=None, parent=None, publisher=None, publication_date=None, last_updated_date=None, icon=None, name_translations=None, comment_translations=None, is_abstract=None, data_properties=None, object_properties=None, properties_order=None, _configuration=None):  # noqa: E501
