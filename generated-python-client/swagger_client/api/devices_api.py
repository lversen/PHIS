...
class DevicesApi(object):
    ...
    def export_devices_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('year' in params and params['year'] > 10000):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('year' in params and params['year'] < 999):  # noqa: E501
