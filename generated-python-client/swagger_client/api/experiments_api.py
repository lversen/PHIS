...
class ExperimentsApi(object):
    ...
    def import_csv_data1(self, uri, provenance, file, authorization, **kwargs):  # noqa: E501
        """Import a CSV file for the given experiment URI and scientific object type.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_csv_data1(uri, provenance, file, authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.import_csv_data1_with_http_info(uri, provenance, file, authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.import_csv_data1_with_http_info(uri, provenance, file, authorization, **kwargs)  # noqa: E501
            return data

    def import_csv_data1_with_http_info(self, uri, provenance, file, authorization, **kwargs):  # noqa: E501
        """Import a CSV file for the given experiment URI and scientific object type.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_csv_data1_with_http_info(uri, provenance, file, authorization, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['uri', 'provenance', 'file', 'authorization', 'accept_language']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def validate_csv2(self, uri, provenance, file, authorization, **kwargs):  # noqa: E501
        """Import a CSV file for the given experiment URI and scientific object type.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.validate_csv2(uri, provenance, file, authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.validate_csv2_with_http_info(uri, provenance, file, authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.validate_csv2_with_http_info(uri, provenance, file, authorization, **kwargs)  # noqa: E501
            return data

    def validate_csv2_with_http_info(self, uri, provenance, file, authorization, **kwargs):  # noqa: E501
        """Import a CSV file for the given experiment URI and scientific object type.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.validate_csv2_with_http_info(uri, provenance, file, authorization, async_req=True)
        >>> result = thread.get()
