...
api_instance = swagger_client.AnnotationsApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.AnnotationCreationDTO() # AnnotationCreationDTO |  (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.AnnotationsApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.AnnotationUpdateDTO() # AnnotationUpdateDTO | Annotation description (optional)
accept_language = 'en' # str | Request accepted language (optional)
