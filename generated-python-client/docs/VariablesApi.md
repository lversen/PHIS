...
body = swagger_client.URIsListPostDTO() # URIsListPostDTO | List of variable URI (optional)
...
# create an instance of the API class
api_instance = swagger_client.VariablesApi()
body = swagger_client.CopyResourceDTO() # CopyResourceDTO | List of variable URI to copy
authorization = 'authorization_example' # str | Authentication token
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.CharacteristicCreationDTO() # CharacteristicCreationDTO | Characteristic description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.EntityCreationDTO() # EntityCreationDTO | Entity description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.InterestEntityCreationDTO() # InterestEntityCreationDTO | Entity of interest description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.MethodCreationDTO() # MethodCreationDTO | Method description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.UnitCreationDTO() # UnitCreationDTO | Unit description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.VariableCreationDTO() # VariableCreationDTO | Variable description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.VariablesGroupCreationDTO() # VariablesGroupCreationDTO | Variables group description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.CharacteristicUpdateDTO() # CharacteristicUpdateDTO | Characteristic description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.EntityUpdateDTO() # EntityUpdateDTO | Entity description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.InterestEntityUpdateDTO() # InterestEntityUpdateDTO | Entity of interest description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.MethodUpdateDTO() # MethodUpdateDTO | Method description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.UnitUpdateDTO() # UnitUpdateDTO | Unit description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.VariableUpdateDTO() # VariableUpdateDTO | Variable description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.VariablesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.VariablesGroupUpdateDTO() # VariablesGroupUpdateDTO | Variables group description (optional)
accept_language = 'en' # str | Request accepted language (optional)
