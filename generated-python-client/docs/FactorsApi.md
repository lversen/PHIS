...
api_instance = swagger_client.FactorsApi()
...
api_instance = swagger_client.FactorsApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.FactorCreationDTO() # FactorCreationDTO | Factor description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.FactorsApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.FactorUpdateDTO() # FactorUpdateDTO | Factor description (optional)
accept_language = 'en' # str | Request accepted language (optional)
