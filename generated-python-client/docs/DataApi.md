...
body = [swagger_client.DataCreationDTO()] # list[DataCreationDTO] | Data description (optional)
...
targets = [swagger_client.list[str]()] # list[str] | Targets uris, can be an empty array but can't be null (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.DataApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.ProvenanceCreationDTO() # ProvenanceCreationDTO | Provenance description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.DataApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.DataSearchDTO() # DataSearchDTO | CSV export configuration (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
experiments = ['http://opensilex/experiment/id/ZA17'] # list[str] | Search by experiment uris (optional)
devices = ['http://opensilex.dev/set/device/sensingdevice-sensor_01'] # list[str] | Search by devices uris (optional)
body = [swagger_client.list[str]()] # list[str] | Search by targets uris (optional)
accept_language = 'en' # str | Request accepted language (optional)

try:
    # Search provenances linked to datafiles for a large list of targets
    api_response = api_instance.get_datafiles_provenances_by_targets(authorization, experiments=experiments, devices=devices, body=body, accept_language=accept_language)
    pprint(api_response)
except ApiException as e:
...
variables = ['http://opensilex.dev/variable#variable.2020-08-21_11-21-23entity6_method6_quality6_unit6'] # list[str] | Search by variables uris (optional)
devices = ['http://opensilex.dev/set/device/sensingdevice-sensor_01'] # list[str] | Search by devices uris (optional)
body = [swagger_client.list[str]()] # list[str] | Targets uris (optional)
accept_language = 'en' # str | Request accepted language (optional)

try:
    # Search provenances linked to data for a large list of targets
    api_response = api_instance.get_used_provenances_by_targets(authorization, experiments=experiments, variables=variables, devices=devices, body=body, accept_language=accept_language)
    pprint(api_response)
except ApiException as e:
...
try:
    # Import a CSV file for the given provenanceURI
    api_response = api_instance.import_csv_data(provenance, file, authorization, experiment=experiment, accept_language=accept_language)
    pprint(api_response)
except ApiException as e:
...
# create an instance of the API class
api_instance = swagger_client.DataApi()
body = [swagger_client.DataFilePathCreationDTO()] # list[DataFilePathCreationDTO] | Metadata of the file
authorization = 'authorization_example' # str | Authentication token
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.DataApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.DataUpdateDTO() # DataUpdateDTO | Data description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
uri = 'uri_example' # str | Data URI
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.DataConfidenceDTO() # DataConfidenceDTO | Data description (optional)
accept_language = 'en' # str | Request accepted language (optional)

try:
    # Update confidence index
    api_response = api_instance.update_confidence(uri, authorization, body=body, accept_language=accept_language)
    pprint(api_response)
except ApiException as e:
...
api_instance = swagger_client.DataApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.ProvenanceUpdateDTO() # ProvenanceUpdateDTO | Provenance description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
try:
    # Import a CSV file for the given provenanceURI.
    api_response = api_instance.validate_csv(provenance, file, authorization, experiment=experiment, accept_language=accept_language)
    pprint(api_response)
except ApiException as e:
