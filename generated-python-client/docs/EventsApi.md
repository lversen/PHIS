...
api_instance = swagger_client.EventsApi()
authorization = 'authorization_example' # str | Authentication token
body = [swagger_client.EventCreationDTO()] # list[EventCreationDTO] |  (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.EventsApi()
authorization = 'authorization_example' # str | Authentication token
body = [swagger_client.MoveCreationDTO()] # list[MoveCreationDTO] |  (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.EventsApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.EventUpdateDTO() # EventUpdateDTO | Event description (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
api_instance = swagger_client.EventsApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.MoveUpdateDTO() # MoveUpdateDTO | Event description (optional)
accept_language = 'en' # str | Request accepted language (optional)
