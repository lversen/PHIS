...
class DataSearchDTO(object):
    ...
    def __init__(self, start_date=None, end_date=None, timezone=None, experiments=None, targets=None, variables=None, devices=None, provenances=None, min_confidence=None, max_confidence=None, metadata=None, mode=None, with_raw_data=None, _configuration=None):  # noqa: E501
    ...
    def min_confidence(self, min_confidence):
        ...
        if (self._configuration.client_side_validation and
                min_confidence is not None and min_confidence > 1):  # noqa: E501
            raise ValueError("Invalid value for `min_confidence`, must be a value less than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                min_confidence is not None and min_confidence < 0):  # noqa: E501
    ...
    def max_confidence(self, max_confidence):
        ...
        """
        if (self._configuration.client_side_validation and
                max_confidence is not None and max_confidence > 1):  # noqa: E501
            raise ValueError("Invalid value for `max_confidence`, must be a value less than or equal to `1`")  # noqa: E501
        if (self._configuration.client_side_validation and
                max_confidence is not None and max_confidence < 0):  # noqa: E501
