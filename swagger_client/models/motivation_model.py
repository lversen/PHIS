...
class MotivationModel(object):
    ...
    def __init__(self, uri=None, publisher=None, publication_date=None, last_update_date=None, relations=None, name=None, type=None, type_label=None, _configuration=None):  # noqa: E501
