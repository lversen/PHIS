...
class ModelProperty(object):
    ...
    def __init__(self, local_name=None, name_space=None, _property=None, ordinal=None, id=None, uri=None, stmt_term=None, resource=None, model=None, literal=None, anon=None, uriresource=None, stmt_resource=None, _configuration=None):  # noqa: E501
