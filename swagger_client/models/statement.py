...
class Statement(object):
    ...
    def __init__(self, subject=None, boolean=None, byte=None, short=None, char=None, _int=None, long=None, _float=None, double=None, resource=None, object=None, language=None, string=None, list=None, model=None, literal=None, bag=None, alt=None, seq=None, predicate=None, reified=None, _configuration=None):  # noqa: E501
