...
class GermplasmGetSingleDTO(object):
    ...
    def __init__(self, uri=None, publisher=None, publication_date=None, last_updated_date=None, rdf_type=None, rdf_type_name=None, name=None, synonyms=None, code=None, production_year=None, description=None, species=None, species_name=None, variety=None, variety_name=None, accession=None, accession_name=None, institute=None, website=None, has_parent_germplasm=None, has_parent_germplasm_m=None, has_parent_germplasm_f=None, metadata=None, _configuration=None):  # noqa: E501
