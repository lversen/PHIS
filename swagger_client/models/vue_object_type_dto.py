...
class VueObjectTypeDTO(object):
    ...
    def __init__(self, uri=None, name=None, short_uri=None, input_component=None, input_components_by_property=None, view_component=None, rdf_type=None, _configuration=None):  # noqa: E501
