...
class EventCreationDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, start=None, end=None, is_instant=None, description=None, targets=None, relations=None, publisher=None, publication_date=None, last_updated_date=None, _configuration=None):  # noqa: E501
