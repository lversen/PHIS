...
class Graph(object):
    ...
    def __init__(self, empty=None, closed=None, prefix_mapping=None, transaction_handler=None, event_manager=None, capabilities=None, _configuration=None):  # noqa: E501
