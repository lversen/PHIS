...
class VueJsApi(object):
    ...
    def get_extension_with_http_info(self, module, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('module' not in params or
                                                       params['module'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `module` when calling `get_extension`")  # noqa: E501

        if self.api_client.client_side_validation and ('module' in params and not re.search(r'([a-zA-Z0-9-]+$)', params['module'])):  # noqa: E501
    ...
    def get_theme_config_with_http_info(self, module_id, theme_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('theme_id' not in params or
                                                       params['theme_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `theme_id` when calling `get_theme_config`")  # noqa: E501

        if self.api_client.client_side_validation and ('module_id' in params and not re.search(r'([a-zA-Z0-9-]+$)', params['module_id'])):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('theme_id' in params and not re.search(r'([a-zA-Z0-9-]+$)', params['theme_id'])):  # noqa: E501
