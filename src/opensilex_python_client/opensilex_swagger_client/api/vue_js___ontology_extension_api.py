...
class VueJsOntologyExtensionApi(object):
    ...
    def set_rdf_type_properties_order(self, authorization, rdf_type, **kwargs):  # noqa: E501
        """Define properties order  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_rdf_type_properties_order(authorization, rdf_type, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_rdf_type_properties_order_with_http_info(authorization, rdf_type, **kwargs)  # noqa: E501
        else:
            (data) = self.set_rdf_type_properties_order_with_http_info(authorization, rdf_type, **kwargs)  # noqa: E501
            return data

    def set_rdf_type_properties_order_with_http_info(self, authorization, rdf_type, **kwargs):  # noqa: E501
        """Define properties order  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_rdf_type_properties_order_with_http_info(authorization, rdf_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'rdf_type', 'body', 'accept_language']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
