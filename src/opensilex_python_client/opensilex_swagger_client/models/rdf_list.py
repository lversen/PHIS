...
class RDFList(object):
    ...
    def __init__(self, empty=None, strict=None, valid=None, validity_error_message=None, head=None, tail=None, id=None, name_space=None, stmt_term=None, uri=None, local_name=None, resource=None, model=None, literal=None, anon=None, uriresource=None, stmt_resource=None):  # noqa: E501
