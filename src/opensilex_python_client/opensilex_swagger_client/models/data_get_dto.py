...
class DataGetDTO(object):
    ...
    def __init__(self, uri=None, _date=None, target=None, variable=None, value=None, confidence=None, provenance=None, metadata=None, raw_data=None, issued=None, modified=None):  # noqa: E501
