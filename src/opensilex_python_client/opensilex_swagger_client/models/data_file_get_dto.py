...
class DataFileGetDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, _date=None, timezone=None, target=None, provenance=None, metadata=None, archive=None, filename=None, publisher=None, issued=None):  # noqa: E501
