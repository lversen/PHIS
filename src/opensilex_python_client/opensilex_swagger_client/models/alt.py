...
class Alt(object):
    ...
    def __init__(self, default=None, default_language=None, default_resource=None, default_literal=None, default_boolean=None, default_byte=None, default_short=None, default_int=None, default_long=None, default_char=None, default_float=None, default_double=None, default_string=None, default_alt=None, default_bag=None, default_seq=None, alt=None, seq=None, bag=None, id=None, name_space=None, stmt_term=None, uri=None, local_name=None, resource=None, model=None, literal=None, anon=None, uriresource=None, stmt_resource=None):  # noqa: E501
