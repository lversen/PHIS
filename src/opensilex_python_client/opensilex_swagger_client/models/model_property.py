...
class ModelProperty(object):
    ...
    def __init__(self, name_space=None, _property=None, ordinal=None, local_name=None, id=None, stmt_term=None, uri=None, resource=None, model=None, literal=None, anon=None, uriresource=None, stmt_resource=None):  # noqa: E501
