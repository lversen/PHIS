...
class UserUpdateDTO(object):
    ...
    def __init__(self, uri=None, first_name=None, language=None, password=None, admin=None, last_name=None, email=None, enable=None, favorites=None, linked_person=None):  # noqa: E501
