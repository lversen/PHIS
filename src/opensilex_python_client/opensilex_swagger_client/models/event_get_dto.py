...
class EventGetDTO(object):
    ...
    def __init__(self, uri=None, publisher=None, rdf_type=None, rdf_type_name=None, start=None, end=None, is_instant=None, description=None, targets=None, publication_date=None, last_updated_date=None):  # noqa: E501
