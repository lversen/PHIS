...
class MoveUpdateDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, start=None, end=None, is_instant=None, description=None, targets=None, relations=None, _from=None, to=None, targets_positions=None, publisher=None, publication_date=None, last_updated_date=None):  # noqa: E501
