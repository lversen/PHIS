...
class RDFPropertyDTO(object):
    ...
    def __init__(self, uri=None, domain=None, range=None, parent=None, rdf_type=None, name_translations=None, comment_translations=None, publisher=None, publication_date=None, last_updated_date=None):  # noqa: E501
