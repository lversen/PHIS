...
class AgroportalLinksModel(object):
    ...
    def __init__(self, _self=None, ontology=None, children=None, parents=None, descendants=None, ancestors=None, instances=None, tree=None, notes=None, ui=None):  # noqa: E501
