...
class ScientificObjectExportDTO(object):
    ...
    def __init__(self, included_uris=None, page=None, lang=None, rdf_types=None, order_by=None, page_size=None, uris=None, excluded_uris=None, experiment=None, name=None, parent=None, germplasm=None, factor_levels=None, facility=None, existence_date=None, creation_date=None):  # noqa: E501
