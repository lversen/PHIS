...
class ScientificObjectUpdateDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, name=None, experiment=None, relations=None, geometry=None, publisher=None, publication_date=None, last_updated_date=None):  # noqa: E501
