...
class VersionInfoDTO(object):
    ...
    def __init__(self, title=None, version=None, description=None, contact=None, license=None, modules_version=None, external_docs=None, api_docs=None, git_commit=None, github_page=None):  # noqa: E501
