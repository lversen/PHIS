...
class FactorDetailsGetDTO(object):
    ...
    def __init__(self, uri=None, publisher=None, publication_date=None, last_updated_date=None, name=None, category=None, description=None, levels=None, exact_match=None, close_match=None, broad_match=None, narrow_match=None, experiment=None):  # noqa: E501
