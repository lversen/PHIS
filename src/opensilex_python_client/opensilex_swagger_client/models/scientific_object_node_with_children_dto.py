...
class ScientificObjectNodeWithChildrenDTO(object):
    ...
    def __init__(self, uri=None, name=None, geometry=None, rdf_type=None, rdf_type_name=None, publication_date=None, last_updated_date=None, creation_date=None, destruction_date=None, child_count=None):  # noqa: E501
