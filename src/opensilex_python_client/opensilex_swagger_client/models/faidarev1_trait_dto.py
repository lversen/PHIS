...
class Faidarev1TraitDTO(object):
    ...
    def __init__(self, trait_db_id=None, name=None, description=None, synonyms=None, main_abbreviation=None, alternative_abbreviations=None, entity=None, attribute=None, status=None, xref=None, _class=None):  # noqa: E501
