...
class Literal(object):
    ...
    def __init__(self, boolean=None, byte=None, short=None, char=None, _int=None, long=None, _float=None, double=None, value=None, language=None, string=None, datatype=None, datatype_uri=None, lexical_form=None, well_formed_xml=None, resource=None, model=None, literal=None, anon=None, uriresource=None, stmt_resource=None):  # noqa: E501
