...
from opensilex_swagger_client.api.organizations_api import OrganizationsApi  # noqa: E501
...
class TestOrganizationsApi(unittest.TestCase):
    ...
    def test_get_sites_with_location(self):
    ...
    def test_minimal_search_facilities(self):
