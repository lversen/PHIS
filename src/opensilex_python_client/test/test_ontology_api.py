...
from opensilex_swagger_client.api.ontology_api import OntologyApi  # noqa: E501
...
class TestOntologyApi(unittest.TestCase):
    ...
    def test_check_uris_types(self):
    ...
    def test_get_properties_by_domain_hierarchy_using_restrictions(self):
    ...
    def test_get_sub_properties_of(self):
