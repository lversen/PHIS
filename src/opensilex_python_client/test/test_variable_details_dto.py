...
from opensilex_swagger_client.models.variable_details_dto import VariableDetailsDTO  # noqa: E501
...
class TestVariableDetailsDTO(unittest.TestCase):
    ...
    def testVariableDetailsDTO(self):
        ...
        # model = opensilex_swagger_client.models.variable_details_dto.VariableDetailsDTO()  # noqa: E501
        pass
