...
def format_data_for_api(record):
    ...
    # from swagger_client.models import DeviceCreationDTO
    #
    # formatted_record = DeviceCreationDTO(
...
def main():
    ...
    # --- Argument Parsing ---
    parser = argparse.ArgumentParser(description="Import script for Devices.")
    ...
    for record in data_to_import:
        try:
            ...
            # --- Make the API call ---
            # api_response = devices_api.create_device(body=formatted_record, authorization=token)
