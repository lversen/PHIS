...
api_instance = swagger_client.DevicesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.DeviceCreationDTO() # DeviceCreationDTO | Device description (optional)
check_only = false # bool | Checking only (optional) (default to false)
accept_language = 'en' # str | Request accepted language (optional)

try:
    # Create a device
    api_response = api_instance.create_device(authorization, body=body, check_only=check_only, accept_language=accept_language)
    pprint(api_response)
except ApiException as e:
...
api_instance = swagger_client.DevicesApi()
authorization = 'authorization_example' # str | Authentication token
body = [swagger_client.GeometryDTO()] # list[GeometryDTO] | Devices (optional)
...
try:
    # Export a given list of devices URIs to shapefile
    api_instance.export_geospatial1(authorization, body=body, selected_props=selected_props, format=format, page_size=page_size, accept_language=accept_language)
except ApiException as e:
...
api_instance = swagger_client.DevicesApi()
authorization = 'authorization_example' # str | Authentication token
body = swagger_client.URIsListPostDTO() # URIsListPostDTO | List of device URI (optional)
accept_language = 'en' # str | Request accepted language (optional)
...
# create an instance of the API class
api_instance = swagger_client.DevicesApi()
description = swagger_client.Object() # Object | CSV import settings
...
# create an instance of the API class
api_instance = swagger_client.DevicesApi()
body = swagger_client.DeviceCreationDTO() # DeviceCreationDTO | Device description
authorization = 'authorization_example' # str | Authentication token
accept_language = 'en' # str | Request accepted language (optional)
