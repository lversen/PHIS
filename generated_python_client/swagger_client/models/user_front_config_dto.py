...
class UserFrontConfigDTO(object):
    ...
    def __init__(self, menu=None, user_is_anonymous=None, _configuration=None):  # noqa: E501
    ...
    def menu(self, menu):
        ...
        """
        if self._configuration.client_side_validation and menu is None:
    ...
    def user_is_anonymous(self, user_is_anonymous):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and user_is_anonymous is None:
