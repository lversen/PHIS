...
class BrAPIv1TraitDTO(object):
    ...
    def __init__(self, alternative_abbreviations=None, attribute=None, description=None, entity=None, main_abbreviation=None, ontology_reference=None, status=None, synonyms=None, trait_db_id=None, trait_name=None, xref=None, _class=None, _configuration=None):  # noqa: E501
