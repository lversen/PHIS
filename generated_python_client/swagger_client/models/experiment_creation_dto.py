...
class ExperimentCreationDTO(object):
    ...
    def __init__(self, uri=None, name=None, start_date=None, end_date=None, description=None, objective=None, organisations=None, facilities=None, projects=None, scientific_supervisors=None, technical_supervisors=None, groups=None, factors=None, is_public=None, _configuration=None):  # noqa: E501
