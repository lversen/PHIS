...
class UserCreationDTO(object):
    ...
    def __init__(self, uri=None, first_name=None, last_name=None, email=None, language=None, password=None, admin=None, enable=None, favorites=None, linked_person=None, _configuration=None):  # noqa: E501
