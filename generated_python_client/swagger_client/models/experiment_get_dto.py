...
class ExperimentGetDTO(object):
    ...
    def __init__(self, uri=None, publisher=None, publication_date=None, last_updated_date=None, name=None, start_date=None, end_date=None, description=None, objective=None, species=None, factors=None, organisations=None, facilities=None, projects=None, scientific_supervisors=None, technical_supervisors=None, groups=None, is_public=None, _configuration=None):  # noqa: E501
