...
class BrAPIv1ObservationVariableDTO(object):
    ...
    def __init__(self, context_of_use=None, crop=None, default_value=None, documentation_url=None, growth_stage=None, institution=None, language=None, method=None, ontology_reference=None, scale=None, scientist=None, status=None, submission_timestamp=None, synonyms=None, trait=None, xref=None, observation_variable_db_id=None, observation_variable_name=None, study_db_id=None, trial_name=None, _configuration=None):  # noqa: E501
