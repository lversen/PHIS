...
class VariableGetDTO(object):
    ...
    def __init__(self, uri=None, name=None, entity=None, entity_of_interest=None, characteristic=None, method=None, unit=None, on_local=None, shared_resource_instance=None, alternative_name=None, _configuration=None):  # noqa: E501
