...
class Faidarev1TrialDTO(object):
    ...
    def __init__(self, active=None, additional_info=None, documentation_url=None, end_date=None, start_date=None, trial_name=None, trial_db_id=None, trial_type=None, dataset_authorship=None, studies=None, contacts=None, program_db_id=None, program_name=None, _configuration=None):  # noqa: E501
