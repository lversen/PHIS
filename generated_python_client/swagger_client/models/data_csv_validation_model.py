...
class DataCSVValidationModel(object):
    ...
    def __init__(self, missing_headers=None, empty_headers=None, invalid_header_uris=None, datatype_errors=None, uri_not_found_errors=None, invalid_uri_errors=None, missing_required_value_errors=None, invalid_value_errors=None, already_existing_uri_errors=None, duplicate_uri_errors=None, invalid_row_size_errors=None, invalid_date_errors=None, nb_object_imported=None, validation_token=None, csv_header=None, invalid_object_errors=None, invalid_annotation_errors=None, invalid_target_errors=None, invalid_data_type_errors=None, invalid_experiment_errors=None, invalid_device_errors=None, device_choice_ambiguity_errors=None, duplicated_data_errors=None, duplicated_object_errors=None, duplicated_target_errors=None, duplicated_experiment_errors=None, duplicated_device_errors=None, headers=None, headers_labels=None, annotations_on_objects=None, nb_lines_imported=None, nb_lines_to_import=None, validation_step=None, insertion_step=None, valid_csv=None, too_large_dataset=None, error_message=None, _configuration=None):  # noqa: E501
