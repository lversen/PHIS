...
class Faidarev1StudyDTO(object):
    ...
    def __init__(self, active=None, additional_info=None, documentation_url=None, end_date=None, location_db_id=None, location_name=None, last_update=None, name=None, program_db_id=None, program_name=None, start_date=None, study_type=None, study_db_id=None, study_name=None, trial_db_id=None, trial_name=None, trial_db_ids=None, contacts=None, data_links=None, study_description=None, seasons=None, observation_variable_db_ids=None, germplasm_db_ids=None, _configuration=None):  # noqa: E501
