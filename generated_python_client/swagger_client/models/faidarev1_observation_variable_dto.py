...
class Faidarev1ObservationVariableDTO(object):
    ...
    def __init__(self, context_of_use=None, crop=None, default_value=None, documentation_url=None, growth_stage=None, institution=None, language=None, method=None, scale=None, scientist=None, status=None, synonyms=None, trait=None, xref=None, observation_variable_db_id=None, name=None, _date=None, ontology_db_id=None, ontology_name=None, _configuration=None):  # noqa: E501
