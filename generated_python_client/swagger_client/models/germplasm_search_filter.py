...
class GermplasmSearchFilter(object):
    ...
    def __init__(self, included_uris=None, rdf_types=None, page=None, lang=None, uri=None, name=None, code=None, species=None, variety=None, accession=None, institute=None, experiment=None, metadata=None, uris=None, group=None, parent_germplasms=None, parent_m_germplasms=None, parent_f_germplasms=None, order_by=None, page_size=None, rdf_type=None, production_year=None, _configuration=None):  # noqa: E501
