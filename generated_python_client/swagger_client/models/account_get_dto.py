...
class AccountGetDTO(object):
    ...
    def __init__(self, uri=None, email=None, admin=None, language=None, enable=None, favorites=None, linked_person=None, person_first_name=None, person_last_name=None, _configuration=None):  # noqa: E501
