...
class PersonDTO(object):
    ...
    def __init__(self, uri=None, first_name=None, last_name=None, email=None, affiliation=None, phone_number=None, orcid=None, account=None, _configuration=None):  # noqa: E501
