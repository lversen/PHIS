...
class SiteCreationDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, name=None, address=None, organizations=None, facilities=None, groups=None, description=None, rdf_type_name=None, publication_date=None, last_updated_date=None):  # noqa: E501
