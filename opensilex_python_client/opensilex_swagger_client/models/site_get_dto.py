...
class SiteGetDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, publisher=None, publication_date=None, last_updated_date=None, name=None, address=None, organizations=None, facilities=None, groups=None, geometry=None, description=None):  # noqa: E501
