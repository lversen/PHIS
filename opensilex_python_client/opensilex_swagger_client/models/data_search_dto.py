...
class DataSearchDTO(object):
    ...
    def __init__(self, start_date=None, end_date=None, timezone=None, experiments=None, targets=None, variables=None, devices=None, provenances=None, min_confidence=None, max_confidence=None, metadata=None, mode=None, with_raw_data=None):  # noqa: E501
