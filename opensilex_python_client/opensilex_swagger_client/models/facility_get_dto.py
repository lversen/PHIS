...
class FacilityGetDTO(object):
    ...
    def __init__(self, uri=None, publisher=None, publication_date=None, last_updated_date=None, rdf_type=None, rdf_type_name=None, name=None, organizations=None, sites=None, address=None, variable_groups=None, geometry=None, relations=None):  # noqa: E501
