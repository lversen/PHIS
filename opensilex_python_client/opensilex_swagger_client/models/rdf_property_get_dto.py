...
class RDFPropertyGetDTO(object):
    ...
    def __init__(self, uri=None, domain=None, range=None, parent=None, name=None, comment=None, rdf_type=None, name_translations=None, comment_translations=None, publisher=None, publication_date=None, last_updated_date=None, domain_label=None, range_label=None):  # noqa: E501
