...
class GroupUserProfileDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, profile_uri=None, profile_name=None, user_uri=None, user_name=None, publication_date=None, last_updated_date=None):  # noqa: E501
