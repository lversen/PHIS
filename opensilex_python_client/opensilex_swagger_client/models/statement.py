...
class Statement(object):
    ...
    def __init__(self, boolean=None, byte=None, short=None, char=None, _int=None, long=None, _float=None, double=None, resource=None, object=None, language=None, string=None, subject=None, list=None, model=None, literal=None, bag=None, alt=None, predicate=None, seq=None, reified=None):  # noqa: E501
