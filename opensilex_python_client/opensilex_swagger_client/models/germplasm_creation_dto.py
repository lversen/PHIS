...
class GermplasmCreationDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, name=None, synonyms=None, code=None, production_year=None, description=None, species=None, variety=None, accession=None, institute=None, website=None, relations=None, metadata=None, publisher=None, publication_date=None, last_updated_date=None):  # noqa: E501
