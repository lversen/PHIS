...
class OrganizationCreationDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, rdf_type_name=None, name=None, parents=None, groups=None, facilities=None, publication_date=None, last_updated_date=None):  # noqa: E501
