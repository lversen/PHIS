...
class Faidarev1LocationDTO(object):
    ...
    def __init__(self, abbreviation=None, abreviation=None, additional_info=None, altitude=None, country_code=None, country_name=None, documentation_url=None, institute_address=None, institute_adress=None, institute_name=None, latitude=None, location_db_id=None, location_name=None, name=None, location_type=None, longitude=None):  # noqa: E501
