...
class GermplasmGroupGetWithDetailsDTO(object):
    ...
    def __init__(self, uri=None, name=None, description=None, publisher=None, publication_date=None, last_updated_date=None, germplasm_count=None, germplasm_list=None):  # noqa: E501
