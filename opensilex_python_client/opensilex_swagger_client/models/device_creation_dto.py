...
class DeviceCreationDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, name=None, brand=None, constructor_model=None, serial_number=None, person_in_charge=None, start_up=None, removal=None, relations=None, description=None, metadata=None, publisher=None, publication_date=None, last_updated_date=None):  # noqa: E501
