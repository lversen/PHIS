...
class SiteGetListDTO(object):
    ...
    def __init__(self, uri=None, name=None, address=None, description=None, organizations=None, facilities=None, rdf_type=None, rdf_type_name=None, publication_date=None, last_updated_date=None):  # noqa: E501
