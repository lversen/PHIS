...
class VariableDetailsDTO(object):
    ...
    def __init__(self, uri=None, name=None, alternative_name=None, description=None, entity=None, entity_of_interest=None, characteristic=None, trait=None, trait_name=None, method=None, unit=None, species=None, time_interval=None, sampling_interval=None, datatype=None, exact_match=None, close_match=None, broad_match=None, narrow_match=None, publisher=None, publication_date=None, last_updated_date=None, from_shared_resource_instance=None):  # noqa: E501
