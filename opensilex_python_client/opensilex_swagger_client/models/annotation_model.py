...
class AnnotationModel(object):
    ...
    def __init__(self, uri=None, publisher=None, publication_date=None, last_update_date=None, relations=None, description=None, motivation=None, targets=None, type=None, type_label=None):  # noqa: E501
