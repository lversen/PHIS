...
class OrganizationUpdateDTO(object):
    ...
    def __init__(self, uri=None, rdf_type=None, name=None, parents=None, groups=None, facilities=None, rdf_type_name=None, publication_date=None, last_updated_date=None):  # noqa: E501
