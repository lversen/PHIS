...
from opensilex_swagger_client.models.agroportal_term_dto import AgroportalTermDTO  # noqa: E501
...
class TestAgroportalTermDTO(unittest.TestCase):
    ...
    def testAgroportalTermDTO(self):
        ...
        # model = opensilex_swagger_client.models.agroportal_term_dto.AgroportalTermDTO()  # noqa: E501
        pass
