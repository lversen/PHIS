...
from opensilex_swagger_client.models.metadata_dto import MetadataDTO  # noqa: E501
...
class TestMetadataDTO(unittest.TestCase):
    ...
    def testMetadataDTO(self):
        ...
        # model = opensilex_swagger_client.models.metadata_dto.MetadataDTO()  # noqa: E501
        pass
