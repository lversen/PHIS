...
from opensilex_swagger_client.models.faidarev1_trial_dto import Faidarev1TrialDTO  # noqa: E501
...
class TestFaidarev1TrialDTO(unittest.TestCase):
    ...
    def testFaidarev1TrialDTO(self):
        ...
        # model = opensilex_swagger_client.models.faidarev1_trial_dto.Faidarev1TrialDTO()  # noqa: E501
        pass
