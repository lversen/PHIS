...
from opensilex_swagger_client.models.account_get_dto import AccountGetDTO  # noqa: E501
...
class TestAccountGetDTO(unittest.TestCase):
    ...
    def testAccountGetDTO(self):
        ...
        # model = opensilex_swagger_client.models.account_get_dto.AccountGetDTO()  # noqa: E501
        pass
