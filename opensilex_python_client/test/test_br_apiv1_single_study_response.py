...
from opensilex_swagger_client.models.br_apiv1_single_study_response import BrAPIv1SingleStudyResponse  # noqa: E501
...
class TestBrAPIv1SingleStudyResponse(unittest.TestCase):
    ...
    def testBrAPIv1SingleStudyResponse(self):
        ...
        # model = opensilex_swagger_client.models.br_apiv1_single_study_response.BrAPIv1SingleStudyResponse()  # noqa: E501
        pass
