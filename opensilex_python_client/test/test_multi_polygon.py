...
from opensilex_swagger_client.models.multi_polygon import MultiPolygon  # noqa: E501
...
class TestMultiPolygon(unittest.TestCase):
    ...
    def testMultiPolygon(self):
        ...
        # model = opensilex_swagger_client.models.multi_polygon.MultiPolygon()  # noqa: E501
        pass
