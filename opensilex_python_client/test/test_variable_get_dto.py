...
from opensilex_swagger_client.models.variable_get_dto import VariableGetDTO  # noqa: E501
...
class TestVariableGetDTO(unittest.TestCase):
    ...
    def testVariableGetDTO(self):
        ...
        # model = opensilex_swagger_client.models.variable_get_dto.VariableGetDTO()  # noqa: E501
        pass
